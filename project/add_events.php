...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO events (title, description, event_date, posted_by) VALUES (?, ?, ?, ?)");
    
    if ($stmt->execute([$title, $description, $event_date, $posted_by])) {
...
<head>
    ...
    <title>Add Event - Student Information Board</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h1>Add New Event</h1>
            <p>Add a new event to the department calendar</p>
        </div>
